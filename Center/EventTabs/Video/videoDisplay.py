...
class VideoDisplay(QMainWindow):
    ...
    def setUI(self):
        ...
        play_video = QAction(QIcon(".\\.\\image\\preview"), "view", self)
        ...
        if self.file:
            if QFileInfo(self.file).isFile():
                try:
                    ...
                    self.mediaPlayer.setPosition(self.strTime2intTime(self.startPos))
    ...
    def getPro(self):
        ...
        self.display_name = self.pro.tab1.display_name.currentText()
