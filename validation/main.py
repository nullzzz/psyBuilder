...
class ValidationWindow(QFrame):
    ...
    def __init__(self):
        ...
        if self.confuse_code != self.local_code:
            self.tip.setText(f"send the code below to get a validation code<br>"
                             ...
                             f"<a href='mailto:yzhangpsy@suda.edu.cn?Subject=Inquire For Validation Code'> Name:  Institute: ")
    ...
    def getHardCode():
        ...
        rand_order = (244, 281, 32, 40, 22, 123, 99, 174, 294, 261, 175, 34, 152, 92, 170, 91, 146, 119, 190, 112, 127,
                      ...
                      69,
                      115, 11, 101, 54, 105, 296, 176, 218, 30, 133, 291, 186, 149, 224, 45, 184, 216, 77, 280, 211,
                      235,
                      ...
                      223,
                      131, 220, 194, 41, 227, 120, 47, 195, 111, 180, 250, 98, 213, 300, 80, 284, 14, 193, 247, 255,
                      156,
