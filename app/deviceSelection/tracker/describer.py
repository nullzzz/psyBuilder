...
from PyQt5.QtWidgets import QWidget, QLabel, QCheckBox, QSpinBox, QGridLayout
...
class Describer(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.IP_address.textChanged.connect(lambda x: self.ipv46AddressChanged.emit(x))
    ...
    def describe(self, tracker_name, info: dict):
        ...
        self.force_drift_correction.setCheckState(info.get("Force drift correction", "") == "yes")
