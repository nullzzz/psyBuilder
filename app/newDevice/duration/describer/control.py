...
from app.newDevice.duration.describer.response import RespTrigger, EyeAction, RespInfo
...
class RespTriggers(Describer):
    def __init__(self, parent=None):
        super(RespTriggers, self).__init__(parent)
...
class EyeActions(Describer):
    def __init__(self, parent=None):
        super(EyeActions, self).__init__(parent)
...
class RespInfos(Describer):
    def __init__(self, parent=None):
        super(RespInfos, self).__init__(parent)
