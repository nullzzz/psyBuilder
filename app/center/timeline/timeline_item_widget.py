...
class TimelineItemWidget(QGraphicsPixmapItem):
    """
    ...
    def __init__(self, parent=None, widget_type: int = None, widget_id: int = None, widget_name: str = ""):
        ...
        """
        super(TimelineItemWidget, self).__init__(parent)
        ...
        # select its widget_type according to its widget add_type.
        self.setPixmap(Func.getImage(f"widgets/{Info.WidgetType[widget_type]}"))
