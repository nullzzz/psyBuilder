...
class GaborGeneral(QWidget):
    ...
    def setUI(self):
        ...
        self.phase.setItemData(0, "-180 to 180, in degrees", Qt.ToolTipRole)
        ...
        self.rotation.setItemData(0,"0 to 180, in degrees",Qt.ToolTipRole)
        ...
        l3 = QLabel("Width:")
        l4 = QLabel("Height:")
        l5 = QLabel("Spatial Frequency:")
        l6 = QLabel("Contrast:")
        l7 = QLabel("Phase (in degrees):")
        l8 = QLabel("Orientation (in degrees):")
        _21 = QLabel("SDx (pixels):")
        _22 = QLabel("SDy (pixels):")
        _23 = QLabel("Background Color:")
        _24 = QLabel("Rotation (in degrees):")
