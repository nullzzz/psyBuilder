...
class GaborGeneral(QWidget):
    ...
    def setUI(self):
        ...
        self._width.addItems(["100", "0", "25", "50", "75"])
        self._width.setEditable(True)
        self._height.addItems(["100", "0", "25", "50", "75"])
        self._height.setEditable(True)
        self.spatial.addItems(["0.033", "0.02", "0.04", "0.06", "0.08"])
        self.spatial.setEditable(True)
        self.contrast.addItems(["1", "0", "0.2", "0.4", "0.6", "0.8"])
        ...
        self.back_color.addItems(["128,128,128", "64,64,64", "192,192,192", "255,255,255"])
