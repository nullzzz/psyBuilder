from PyQt5.QtCore import pyqtSignal, Qt, QSize, QByteArray, QDataStream, QMimeData, QIODevice
from PyQt5.QtGui import QCursor, QDrag, QIcon
from PyQt5.QtWidgets import QListWidget, QMenu, QListWidgetItem, QListView, QFrame, QWidget, QTabWidget
